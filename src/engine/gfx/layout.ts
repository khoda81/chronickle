...
/** Sample density plus optional adapter reports below every signal heatmap. */
...
export const REPORT_HEIGHT = COVERAGE_BAR_HEIGHT - DATA_HEIGHT;
export const REPORT_UNDERLINE_DEVICE_PX = 2;
